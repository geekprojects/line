...
SRCS=main.cpp line.cpp elfprocess.cpp syscall.cpp fsinstruction.cpp elfbinary.cpp utils.cpp
OBJS=$(SRCS:.cpp=.o)
...
all: $(OBJS)
	ld -arch x86_64 -macosx_version_min 10.12.0 $(OBJS) -o line -lc -map map -image_base 0x7bf00000 -pagezero_size 0x1000 -framework CoreFoundation -no_pie -lstdc++ -sectcreate __TEXT __info_plist info.plist
